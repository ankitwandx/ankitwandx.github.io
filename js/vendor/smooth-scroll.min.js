...
function scrollFunction() {
    if (document.body.scrollTop > 20 || document.documentElement.scrollTop > 20 && screen.width<996) {
        document.getElementById("scroll-to-top-tele").style.display = "block";
    } else {
        document.getElementById("scroll-to-top-tele").style.display = "none";
    }
}
